            ...
            <%@ include file="header.jsp" %>
                ...
                <main>
                    <h2>Agregar Tipo de Producto</h2>
                            <form>
                            <input type="text" placeholder="Nombre del tipo de producto" required>
                            <input path="fechaCreacion" id="fechaCreacion" type="date" required="true" />
                            <button type="submit">Agregar Tipo de Producto</button>
                            </form>
